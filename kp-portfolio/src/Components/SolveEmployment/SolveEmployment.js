...
class SolveEmployment extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: true
      ...
      <>
        ...
        <div className="CaseStudy">
          ...
          <p className="body">
            ...
            seven UX designers each were given the opportunity to improve the
            user experience of the current hiring web application.
            <br />
            <br />
            My team of seven designers further split into 3 groups to focus on
            each user type: the admin, talent, and employer. Our subgroup
            focused on understanding the needs of talents and creating a
            seamless mobile experience for searching jobs and completing work.
          </p>
          <img src={phones} alt="phone screens" className="med__img" />

          <h1 className="header">Problems Determined by stakeholders</h1>
          <p className="body">
            Stakeholder interviews were conducted with the head developer, head
            UX design and CEO of Solve Education (the parent organization of
            Solve Employment). The main complaints users had with the platform
            was that it was difficult to navigate, as well as understand how
            many jobs had been applied for or were active.
          </p>
        </div>
        <img
        ...
        <div className="CaseStudy">
          ...
          <p className="body">
            ...
            building this for, we went into the research phase of our project.
            Our team focused on teenagers and young adults 16-28. In Indonesia,
            half of the audience that utilizes solve employment are young adults
            trying to find work in order to provide for their family.
            <br />
            <br />
            We designed a proto persona and created a mental model scenario of
            the user navigating through solve employment.
          </p>
          ...
          <p className="body">
            ...
            decided to create a new site map that will enhance the user
          ...
          <p className="body">
            ...
            section. We wanted to distill the core sections that applicants
            would utilize the most for Solve Employment.
          </p>
          ...
          <p className="body">
            ...
            <br />
            <br />
            The initial design of the website had a table interface. Not only
            did the UI appear outdated, it did not create an enjoyable
            experience. Our design was meant to remedy this. Now if the user
            chooses to dig deeper into their status, they are presented with the
            option of clicking the content they wish to investigate and will be
            directed to their desired screen with expanded information on their
            desired subject.
          </p>
          ...
          <p className="body">
            ...
            section at the top of each dashboard to illuminate information such
            as active jobs or applications. The user is now able to view the
            progress of their active jobs, applications, and disputes as they
            are submitted, without having to hunt for the information.
          </p>
          ...
          <p className="body">
            ...
            interviews, our team realized there were two major pain points we
            had to resolve.
            <br />
            <br />
            <mark className="bold">
            ...
            <br />
            <mark className="bold">
              2. The current jobs page did not have the ability to check
              progress or terminate a job in an intuitive way.
            </mark>
            <br />
            <br />
            The talent team added the ability on “Current jobs” to click on the
            hirer name to visit their company profile and the ability to click
            the job name to bring it to the page that allows progress updates
            and termination.
          </p>
          ...
          <p className="body">
            ...
            recordings, and Figma prototype to the stakeholders. The
            stakeholders favored the dashboard layout with a menu that talents
            can tab through to take a quick glance and view applications, work
            progress, and disputes.
            <br />
            <br />
            During the design process of Solve Employment, I’ve learned to
            communicate, speak up, and provide feedback when you know your team
            is not headed in the right direction. I also learned that just
            because a stakeholder provides you with company issues and
            deliverables, doesn’t mean your job is done as a problem solver.
            There’s still a long road to discovering complex problems as a
            designer.
          </p>
